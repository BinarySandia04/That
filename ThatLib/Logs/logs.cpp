...
ThatLib::Logs::Color::Color(uint8_t r, uint8_t g, uint8_t b){
  this->r = r;
  this->g = g;
  this->b = b;
}
...
void ThatLib::Logs::Gradient(std::string text, Color c1, Color c2){
  std::string res = "";
  Color c = c1;
  float t = 0;
...
std::string ThatLib::Logs::color(Color c) {
  std::string res = "";
